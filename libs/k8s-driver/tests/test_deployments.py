...
class TestDeploymentManager:
    ...
    def test_create_deployment(
        self, mock_cluster_connection, sample_deployment_spec, mock_k8s_deployment
    ):
        """Test creating a deployment."""
        mock_cluster_connection.apps_v1.create_namespaced_deployment.return_value = (
            mock_k8s_deployment
        )
        ...
        # Verify namespace
        call_args = (
            mock_cluster_connection.apps_v1.create_namespaced_deployment.call_args
        )
    ...
    def test_get_deployment_exists(self, mock_cluster_connection, mock_k8s_deployment):
        ...
        mock_cluster_connection.apps_v1.read_namespaced_deployment.return_value = (
            mock_k8s_deployment
        )
        ...
        mock_cluster_connection.apps_v1.read_namespaced_deployment.assert_called_once_with(
    ...
    def test_get_deployment_not_found(self, mock_cluster_connection):
        ...
        mock_cluster_connection.apps_v1.read_namespaced_deployment.side_effect = (
    ...
    def test_scale_deployment(self, mock_cluster_connection, mock_k8s_deployment):
        ...
        mock_cluster_connection.apps_v1.patch_namespaced_deployment_scale.return_value = (
            mock_k8s_deployment
        )
        ...
        call_args = (
            mock_cluster_connection.apps_v1.patch_namespaced_deployment_scale.call_args
        )
    ...
    def test_delete_deployment_success(self, mock_cluster_connection):
        ...
        mock_cluster_connection.apps_v1.delete_namespaced_deployment.assert_called_once_with(
            "test-deployment", "default"
        )
    ...
    def test_delete_deployment_not_found(self, mock_cluster_connection):
        ...
        mock_cluster_connection.apps_v1.delete_namespaced_deployment.side_effect = (
            ApiException(status=404)
        )
    ...
    def test_list_deployments(self, mock_cluster_connection, mock_k8s_deployment):
        ...
        mock_cluster_connection.apps_v1.list_namespaced_deployment.return_value = (
            mock_list
        )
